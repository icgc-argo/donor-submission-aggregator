import { Analysis, AnalysisType, RunState, TumourNormalDesignationValue } from 'rdpc/types';
		...
		runs: [
			{
				runId: 'wes-cd5ee9084062405983f13d4c194f715f',
				state: RunState.COMPLETE,
				repository: 'https://github.com/icgc-argo/gatk-mutect2-variant-calling.git',
				inputAnalyses: [
					{
						analysisId: '381c2685-b3c9-43ae-9c26-85b3c9d3ae5f',
					},
...
export const variantCallingAnalyses_open: Analysis[] = [
	{
		analysisId: 'e72b062d-f3dc-45dc-ab06-2df3dc75dc4b',
		...
		runs: [
			{
				runId: 'wes-cd5ee9084062405983f13d4c194f715f',
				state: RunState.COMPLETE,
				repository: 'https://github.com/icgc-argo-workflows/open-access-variant-filtering',
				inputAnalyses: [
					{
						analysisId: '381c2685-b3c9-43ae-9c26-85b3c9d3ae5f',
					},
...
export const variantCallingAnalyses: Analysis[] = [
	...
	{
		analysisId: '43ef7db4-8acd-4c25-af7d-b48acd1c25ba',
		analysisType: 'variant_calling',
		firstPublishedAt: '1636976273538',
		workflow: {
			workflowName: 'Open Access Variant Filtering',
		},
		donors: [
			{
				donorId: 'DO35082',
	...
	{
		analysisId: '53ef7db4-8acd-4c25-af7d-b48acd1c25ba',
		analysisType: 'variant_calling',
		firstPublishedAt: '1636987073538',
		workflow: {
			workflowName: 'Open Access Variant Filtering',
		},
		donors: [
	...
	{
		analysisId: '63ef7db4-8acd-4c25-af7d-b48acd1c25ba',
		analysisType: 'variant_calling',
		firstPublishedAt: '1636997873538',
		workflow: {
			workflowName: 'Open Access Variant Filtering',
		},
		donors: [
