...
import { countOpenAccessRunState, getAllMergedDonor } from '../analysesProcessor';
...
export const getOpenAccessData = async (
	...
	const rdpcInfoByDonor_openAccess = countOpenAccessRunState(mergedOpenAccessDonors);
