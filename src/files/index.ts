...
export const indexFileData = async (
	...
	const donorFileInfo = await determineReleaseStatus(programId, fetchFileData, donorsUpdated);
	...
	if (esDocuments.length) {
		logger.info(`Begin bulk indexing donor file data of program ${programId}...`);
